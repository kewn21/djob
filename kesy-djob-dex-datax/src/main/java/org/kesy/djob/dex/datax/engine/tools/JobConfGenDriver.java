...
package org.kesy.djob.dex.datax.engine.tools;
...
public class JobConfGenDriver {
	...
	public static int produceXmlConf() throws IOException {
		...
		Map<PluginType, List<String>> plugins = filterPluginType(ConfigConsts.CONF_ROOT_PATH + "/datax/plugins/");
		...
		String readerPath = ConfigConsts.CONF_ROOT_PATH + "/datax/plugins/reader/"
		...
		String writerPath = ConfigConsts.CONF_ROOT_PATH + "/datax/plugins/writer/"
