...
public abstract class PluginWorker {
	...
	private Log logger = LogFactory.getLog(PluginWorker.class);
	...
	public PluginWorker(PluginConf pluginConf, Class<?> myClass) {
		try {
			...
			this.setParam = myClass.getMethod("setParam",
					new Class[] { Class.forName("org.kesy.djob.dex.datax.common.plugin.PluginParam") });

			this.setMonitor = myClass
					.getMethod("setMonitor", new Class[] { Class
							.forName("org.kesy.djob.dex.datax.common.plugin.PluginMonitor") });
			...
			this.regMyMetaData = myClass.getMethod("setMyMetaData",
					new Class[] { Class.forName("org.kesy.djob.dex.datax.common.plugin.MetaData") });
