...
public class DBSource {
	...
	public static boolean register(Class<? extends Pluginable> clazz, String ip,
			String port, String dbname, String url, String username, Properties p) {

		String id = genKey(clazz, ip, port, dbname, url, username);
	...
	public static DataSource getDataSource(Class<? extends Pluginable> clazz,
			String ip, String port, String dbname, String url, String username) {
		return getDataSource(genKey(clazz, ip, port, dbname, url, username));
	}
	...
	public static Connection getConnection(Class<? extends Pluginable> clazz,
			String ip, String port, String dbname, String url, String username) {
		return getConnection(genKey(clazz, ip, port, dbname, url, username));
	}
	...
	public static String genKey(Class<? extends Pluginable> clazz, String ip,
			String port, String dbname, String url, String username) {
		/*String str = clazz.getCanonicalName() + "_" + ip + "_" + port + "_"
				+ dbname;*/
		
		String str = (StringUtils.isEmpty(url) ? 
				clazz.getCanonicalName() + "_" + ip + "_" + port + "_"
				+ dbname
				:url) + "_" + username;
